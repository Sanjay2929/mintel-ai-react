  ...
  return (
    <div className="relative">
      <div className="pt-[82px] container xl:max-w-[1140px] px-4 xl:px-0 mx-auto lg:pb-[120px] pb-20 relative z-10">
        ...
        <div className="flex lg:justify-between justify-center md:pt-[60px] pt-10 flex-wrap gap-[24px] gap-y-[25px]">
          {salesSuffer.map((value, index) => {
            return (
              <div
                ...
                className="lg:w-[calc(33%-16px)] sm:w-[calc(50%-12px)] w-full   max-w-[400px] flex flex-col items-center border border-green border-opacity-20 rounded-xl py-[32px] px-4 hover:bg-lightGreen duration-300 shadow-[0px_0px_22.9px_0px_#0BB89D1F] cards_sales group hover:lg:!scale-[108%] hover:!scale-[105%]"
              >
                <span className="p-4 bg-green bg-opacity-10 rounded-full group-hover:bg-opacity-100">
                  {value.icon}
                </span>
                <p
                  className={`text-white font-proxima font-semibold text-center text-2xl pt-7 duration-300 ${
                    index === 1 ? "" : "w-[260px]"
                  }`}
                >
                  {value.title}
