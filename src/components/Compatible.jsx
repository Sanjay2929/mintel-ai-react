  ...
  return (
    <div className="relative">
      <div className="lg:py-[140px] py-20 container xl:max-w-[1140px] px-4 xl:px-0 mx-auto">
        ...
        <div className="flex sm:justify-between justify-center items-center max-w-[829px] md:pt-[60px] pt-10 mx-auto sm:gap-10 gap-y-6 gap-x-10 flex-wrap">
          <a
            className="flex lg:text-[34px] sm:text-2xl text-xl text-white font-bold gap-1 items-center"
            href="/"
          >
            <LinkedIn /> Recruiter
          </a>
